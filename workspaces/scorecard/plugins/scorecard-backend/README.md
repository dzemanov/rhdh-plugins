...
Collectors are reusable data-fetching contracts used by metric providers. They are registered through `scorecardCollectorsExtensionPoint`, resolved through `scorecardCollectorRegistryServiceRef`, and consumed via `collectWithContract`.
